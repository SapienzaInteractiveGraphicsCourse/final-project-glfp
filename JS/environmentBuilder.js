...
//coordinate positions of trees in the map			
...
//coordinate positions of hedges in the map				 
...
//coordinate positions of car pieces in the map
...
export default function buildEnvironment(values){
	...
	let materialGround = new CANNON.ContactMaterial(groundMesh.materialC, playerMesh.materialC, {friction: 0, restitution: 0});
	world.addContactMaterial(materialGround);
	
	let materialBridge = new CANNON.ContactMaterial(bridgeMesh.materialC, playerMesh.materialC, {friction: 0, restitution: 0});
	world.addContactMaterial(materialBridge);

	let materialCar = new CANNON.ContactMaterial(groundMesh.materialC, carMesh.materialC, {friction: 0, restitution: 0});
	world.addContactMaterial(materialCar);

	let materialCar2 = new CANNON.ContactMaterial(groundMesh.materialC, carMesh.materialC2, {friction: 0, restitution: 0});
	world.addContactMaterial(materialCar2);

	let materialCarPlayer = new CANNON.ContactMaterial(carMesh.materialC, playerMesh.materialC, {friction: 0, restitution: 0});
	world.addContactMaterial(materialCarPlayer);
	
	let materialTend = new CANNON.ContactMaterial(tendMesh.materialC, playerMesh.materialC, {friction: 0, restitution: 0});
	world.addContactMaterial(materialTend);
	
	let materialscarecrow = new CANNON.ContactMaterial(scarecrowMesh.materialC, playerMesh.materialC, {friction: 0, restitution: 0});
	world.addContactMaterial(materialscarecrow);
	
	let materialwoodaxe = new CANNON.ContactMaterial(woodaxeMesh.materialC, playerMesh.materialC, {friction: 0, restitution: 0});
	world.addContactMaterial(materialwoodaxe);

	let materialgate = new CANNON.ContactMaterial(gateMesh.materialC, playerMesh.materialC, {friction: 0, restitution: 0});
...
function spawnTrees(){
	...
	for(let i = 0; i < treePositions.length; i++){
		...
		let material = new CANNON.ContactMaterial(tmp[1], playerMesh.materialC, {friction: 0, restitution: 0});
