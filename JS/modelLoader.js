...
export async function loadModel(){
	...
	const groundMesh = new THREE.Mesh(planeGeometry, phongMaterial)
	...
	groundMesh.body = planeBody;
	groundMesh.materialC = planeMaterial;
	...
	carMesh.body = tmp[0];
	carMesh.materialC = tmp[1];
	tmp = getBody(carMesh, 20, dims);
	carMesh.body2 = tmp[0];
	carMesh.materialC2 = tmp[1];
	carMesh.castShadow = true;
	
	//////////////////////////////////////////////////

	// 7 - load torch
	var torchMesh = await getModel("./Models/Torch/scene.gltf", 10	, 0, 1, 0);
	...
	bonfireMesh.materialC = bonfireMaterial;
